...
図\ref{code:overview:extraction}のコマンドを実行すると、\coqi{factorial_behv}のErlang実装が図\ref{code:overview:fact-impl-erl}のようなコードで\texttt{factorial.erl}というファイル名で吐き出される。
